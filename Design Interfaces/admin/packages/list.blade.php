            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button onclick="window.location.href='{{ route('admin.job_ads.create') }}'" class="btn btn-icon btn-rounded btn-primary float-right">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="{{ route('admin.job_ads.edit', $package->package_id) }}" class="btn btn-link btn-lg" data-toggle="tooltip" title="Edit">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                @if($package->subscriptions_count == 0)
                                                    <button onclick="confirmDelete('{{ route('admin.job_ads.destroy', $package->package_id) }}')" type="submit" class="btn btn-link btn-danger" data-toggle="tooltip" title="Remove">
